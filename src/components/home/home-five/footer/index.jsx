          ...
          <div className="row">
            <div className="col-xl-4 col-md-12">
              <div className="sofax-footer-wrap mr-25">
                ...
                <p>
                  Het Dynamic is a reputable company founded in 2018,
                  specializing in immigration services and student education
                  consulting. Our mission is to provide comprehensive support to
                  entrepreneur seeking to immigrate to Canada.
                </p>
                <div className="sofax-social-icon">
                  <ul>
                    <li>
                      <a target="_blank" href="https://www.x.com/hetdynamic">
                        <svg
                          width="17"
                          height="18"
                          viewBox="0 0 17 18"
                    ...
                    <li>
                      <a
                        target="_blank"
                        href="https://www.facebook.com/hetdynamic"
                      >
                        <svg
                          width="11"
                          height="18"
                    ...
                    <li>
                      <a
                        target="_blank"
                        href="https://www.instagram.com/hetdynamic_ltd/"
                      >
                        <svg
                          width="18"
                          height="17"
                    ...
                    <li>
                      <a
                        target="_blank"
                        href="https://ng.linkedin.com/company/het-dynamic/"
                      >
                        <svg
                          width="16"
                          height="16"
            ...
            <div className="col-xl-3 col-md-4">
              <div className="sofax-footer-menu ml-50">
                ...
                <ul>
                  <li>
                    <a href="https://hetdynamic.com/about">About Us</a>
                  </li>
                  <li>
                    <a href="https://hetdynamic.com/contact">Contact US</a>
                  </li>
                  <li>
                    <a href="https://hetdynamic.com/privacy-policy">
                      Privacy Policy
                    </a>
                  </li>
                  <li>
                    <a href="https://hetdynamic.com/terms-conditions">
                      Terms & Conditions
                    </a>
                  </li>
                </ul>
