...
const testimonialData = [
  ...
  },
  {
    ...
    rating: 5,
    review:
      "It’s an all-in-one solution to that the has turbocharged the growth. The lead generation and capabilities. our partner & result spesk.",
    author: {
      ...
      <div className="container">
        ...
        <FadeInUp className="sofax-testimonial-btn">
          <Link
            ...
            data-text="See More Client’s Stories"
